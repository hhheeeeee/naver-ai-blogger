...
const buildRestaurantHtml = ({ blogName, restaurantAddress, notes }) => {
  const lines = [
    ...
    '<p>방문 전부터 기대했던 분위기와 실제 경험을 중심으로 정리했습니다.</p>',
    '<h3>분위기</h3>',
    '<p>사진에서 보이는 공간감, 좌석 배치, 조명, 테이블 분위기를 자연스럽게 풀어 주세요.</p>',
    '<h3>음식과 경험</h3>',
    '<p>업로드된 사진을 기준으로 메뉴 구성, 맛의 인상, 식사 흐름을 구체적으로 설명해 주세요.</p>',
    '<h3>방문 팁</h3>',
    '<p>주소, 동선, 예약 여부, 함께 가기 좋은 상황을 독자에게 도움이 되게 정리해 주세요.</p>',
  ];
